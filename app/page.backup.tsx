  ...
  return (
    <main className="min-h-screen p-4 md:p-8 relative z-10">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          >
            <img 
              src="/icon.jpg" 
              alt="Degen Icon" 
              className="w-12 h-12 md:w-16 md:h-16 rounded-degent-card border border-degent-border/50"
            />
          ...
          <a 
            ...
            target="_blank" 
            rel="noopener noreferrer"
            className="text-degent-muted text-lg hover:text-degent-green transition-colors"
          >
            by Degent Club
          </a>
        </div>
        ...
        {/* Footer */}
        <div className="mt-12 text-center text-degent-muted text-sm">
          <p>Powered by <a href="https://skrybit.io" className="hover:text-degent-green transition-colors">Skrybit API</a> • <a href="https://unisat.io" className="hover:text-degent-green transition-colors">UniSat Wallet</a></p>
        </div>
      </div>
    </main>
  );
